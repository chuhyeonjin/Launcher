    ...
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent(
                ...
                '수성 온라인 서버와 통신할 수 없어, 배포 인덱스를 불러올 수 없습니다. 사용 가능한 로컬 배포 인덱스가 없습니다.<br><br>배포 인덱스는 수성 런처 실행에 반드시 필요한 파일 입니다. 해당 파일이 없어 런처를 실행할 수 없습니다. 인터넷 연결 확인 후, 런처를 다시 실행해 주세요.',
                '확인'
            )
            setOverlayHandler(() => {
