        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/norhu1130/Launcher/releases/download/v${info.version}/Mercurylauncher-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : ''}.dmg`
                    showUpdateUI(info)
                }
